...
int main(int argc, char **argv)
{
   ...
   char *sql = 
   "CREATE TABLE Mesaje_offline (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, utilizator_sursa TEXT NOT NULL, utilizator_destinatie TEXT NOT NULL, mesaj TEXT NOT NULL,  data_trimitere TEXT NOT NULL);";
