...
int main(int argc, char **argv)
{
   ...
   char *sql = 
   "CREATE TABLE Utilizatori (id_Utilizator INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,nume_utilizator TEXT NOT NULL, parola TEXT NOT NULL, numar_telefon TEXT NOT NULL, status TEXT, descriptor INTEGER NOT NULL);";
